...
import Entities from "./modules/backend/javaSpring/pages/Entities";
import Repositories from "./modules/backend/javaSpring/pages/Repositories";
import { MUITheme } from "./syles/MUITheme";
import { Button, IconButton, Modal, Typography } from "@mui/material";
import Services from "./modules/backend/javaSpring/pages/Services";

import Controllers from "./modules/backend/javaSpring/pages/Controllers";
import InitSQL from "./modules/backend/javaSpring/pages/InitSQL";
import TableJSONView from "./modules/backend/javaSpring/pages/TableJSONView";
import FolderView from "./modules/backend/javaSpring/pages/FolderView";
import DTOInput from "./modules/backend/javaSpring/pages/DTOInput";
// import ReactHooks from "./modules/frontend/react/pages/ReactHooks";
...
import DTOOutput from "./modules/backend/javaSpring/pages/DTOOutput";
import { boxStyle } from "./syles/BoxStyle";
import Configuration from "./modules/backend/javaSpring/pages/Configuration";
import ServiceDTOInput from "./modules/backend/javaSpring/pages/ServiceDTOInput";
